...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3640.1902876068166; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0.6974373400009483; // x position of the perpendicular encoder (in tick units)
    }
